...
http://github.com/Unity-Billal-mesloub
...
#### github.com/Unity-Billal-mesloub
https://github.com/Unity-Billal-mesloub is a GitHub organization which support many 
package manager like npm, Bower, Component, Jam, volo, ...

https://github.com/Unity-Billal-mesloub/components
...
Bower has now their own [bower.json](https://github.com/Unity-Billal-mesloub/bower.json-spec) 
file. But in earlier versions they used 
[component.json](https://groups.google.com/forum/#!topic/twitter-bower/Dcq8G0en1WI). 
Some properties of `bower.json` and [component's](https://github.com/Unity-Billal-mesloub/spec/blob/main/component.json/specifications.md) `component.json` have the 
